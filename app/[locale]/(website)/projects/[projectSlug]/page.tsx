...
export default async function ProjectItem({
  ...
  if (project.donationSection && !project.disableDonations) {
    schemas.push(
      buildDonateAction({
    ...
    <>
      ...
      <section>
        <div className="mx-auto">
          ...
          {/* DONATIONS DISABLED — will be re-enabled when charity status is confirmed */}
          {/* {!project.disableDonations && project.donationSection && (
            <DonationItems
          ...
          {/* Show "Donations Coming Soon" message since all donations are disabled 
          <section className="py-12 px-4">
            <div className="max-w-3xl mx-auto text-center bg-purple-50 rounded-2xl p-12 border border-purple-200">
              <h3 className="text-xl font-bold text-purple mb-2">Donations Coming Soon</h3>
              <p className="text-brand-grey">We are currently in the process of becoming a registered charity. Donations will be available very soon.</p>
            </div>
          </section>*/}
