...
// DONATIONS DISABLED — fetch all projects (previously filtered by donation items)
          ...
          {!projects || projects.length === 0 ? (
            ...
            projects.map((project, projIdx) => (
              <div key={project._id}>
                ...
                {/* DONATIONS DISABLED — Donation Item Cards commented out */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
                  ...
                  <div className="bg-purple-faint border border-purple/20 rounded-sm p-8 mt-8 text-center">
                    <p className="text-purple font-medium mb-3">Donations are coming soon</p>
                    <p className="text-brand-grey mb-4">We're currently setting up our donation system. Check back soon to support this project.</p>
                    <Link href={`/projects/${project.slug}`} className="text-purple font-bold underline hover:text-purple-dark inline-block">
