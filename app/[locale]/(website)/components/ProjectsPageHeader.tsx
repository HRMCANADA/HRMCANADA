...
// DONATIONS DISABLED — preserve donation UI dependencies for future re-enablement.
...
// DONATIONS DISABLED — Fallback hero amounts commented out (was used as backup donation options)
...
export default function ProjectsPageHeader({
  ...
  // DONATIONS DISABLED — preserve the amount selection logic for future re-enablement.
  ...
  /* DONATIONS DISABLED — preserve selection and basket logic for future re-enablement.
      ...
      <div className="flex flex-col-reverse md:flex-row bg-purple-dark text-brand-white lg:shadow-xl relative z-10 w-full sm:shadow-none sm:pt-0">
        ...
        <div className="w-full md:w-[50%] flex justify-end">
          ...
          <div className="w-full max-w-150 px-6 py-12 md:px-8 md:py-24 lg:py-32 xl:pl-0 flex flex-col items-start text-left">
            ...
            {/* DONATIONS DISABLED — amount buttons, Other Amount, Zakat, and basket button preserved below. */}
            {/*
