...
export async function GET() {
  ...
  markdown += `> Human Relief Mission is a UK-registered charity (No. Pending) delivering emergency relief, clean water, healthcare, education, and sustainable development programmes to communities in Afghanistan, Pakistan, and Nigeria.\n\n`;
